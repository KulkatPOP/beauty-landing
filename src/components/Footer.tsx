...
export function Footer({ data }: { data: CreatorData }) {
  return <footer className="flex flex-col gap-7 border-t border-current/15 px-6 py-10 md:flex-row md:items-center md:justify-between md:px-12">
    ...
    <div className="text-xs opacity-55"><a className="transition-opacity hover:opacity-70" href="mailto:marcas@sofiarose.com">marcas@sofiarose.com</a><p className="mt-1">© 2026 · Media kit profesional</p></div>
  </footer>;
}
